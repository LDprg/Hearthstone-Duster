...
class Response {
	constructor() {
		...
		this[INTERNALS$1] = {
			...
			headers: new Headers$1(opts.headers)
		};
	}
...
function fetch$1(url, opts) {
	...
	return new fetch$1.Promise(function (resolve, reject) {
		...
		req.on('response', function (res) {
			...
			// handle redirect
			if (fetch$1.isRedirect(res.statusCode) && request.redirect !== 'manual') {
				...
				resolve(fetch$1(new Request(resolve_url(request.url, res.headers.location), requestOpts)));
				return;
			}
